...
* Resources
    ...
    ** link:https://github.com/isel-leic-daw/s2526i-53d-51n-public/tree/main/code/js/js-intro-leic53d[js-intro-leic53d].
...
* Laboratory class about state management and component communication in the React library.
    ** link:exercises-and-guides/8-react-state.adoc[Exercise on React state management].

* An introduction to React component effects and the `useEffect` hook function.

* Resources
    ** link:exercises-and-guides/8-react-state.adoc[Exercise on React state management].
    ** link: https://react.dev/reference/react/useEffect[The `useEffect` hook function].
