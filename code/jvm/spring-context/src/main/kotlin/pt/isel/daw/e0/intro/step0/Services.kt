...
/*
 * Step 0: initial state, with no inversion of control
 * - PasswordService is responsible for creating its dependencies
 */

class PasswordService {
    private val passwordTransformer: PasswordTransformer = UnsecureSha1BasedPasswordTransformer()
...
class UnsecureSha1BasedPasswordTransformer : PasswordTransformer {
