package pt.isel.daw.springbootmvcintro.controllers
...
import pt.isel.daw.springbootmvcintro.ClientIp
...
class ArgumentResolutionExamplesController {
     ...
     */
    @GetMapping("4")
    fun handler45(httpServletRequest: HttpServletRequest) = "Hello ${httpServletRequest.remoteAddr}"
    ...
    @GetMapping("8")
    fun handler8(clientIp: ClientIp) = "handler8, clientIp=${clientIp.ipAddress}"
}
